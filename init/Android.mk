...
$(root_init_real): $(TARGET_RECOVERY_ROOT_OUT)/system/bin/toybox_static $(PRODUCT_OUT)/utilities/keycheck $(PRODUCT_OUT)/utilities/init_sony
	cp $(TARGET_RECOVERY_ROOT_OUT)/system/bin/toybox_static $(TARGET_ROOT_OUT)/sbin/toybox_init
